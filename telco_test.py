...
class TestDataPipeline(unittest.TestCase):
    ...
    def test_data_extraction(self):
        ...
        data = data_extraction('test_data.csv')
        ...
        data = data_extraction('empty_data.csv')
        ...
        with self.assertRaises(FileNotFoundError, msg="No exception raised for non-existent file"):
            data = data_extraction('nonexistent_file.csv')
    ...
    def test_data_transformation(self):
        ...
        transformed_data = data_transformation(self.test_data)
    ...
    def test_data_loading(self):
        ...
        data_loading(self.test_data, output_file)
